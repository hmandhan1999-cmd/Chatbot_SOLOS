...
if "vectorstore" not in st.session_state:
    ...
    st.session_state.loader = UnstructuredPDFLoader(r"data/Corporate Sales deck.pdf")
    st.session_state.documents = st.session_state.loader.load()

    st.session_state.text_splitter = RecursiveCharacterTextSplitter(chunk_size=800, chunk_overlap=160)
...
llm = ChatGroq(model="openai/gpt-oss-120b", base_url="http://172.31.21.150:11434", temperature=0, max_tokens=1000)
